...
- cabine alta em uma única peça arredondada;
- capô único e arredondado, sem blocos sobrepostos aparentes;
...
GENERATOR_VERSION = "1.2-styletruck-proporcoes-corrigidas"
GROUND_SIZE = 90.0
GROUND_MARGIN = 7.0
...
def build_styletruck_model(scene):
    ...
    create_beveled_box(
        "Cab_Main_Rounded",
        local_center=(cab_center_x, 0.0, 2.13),
        size_xyz=(cab_length, 2.20, 2.04),
        collection=model_collection,
