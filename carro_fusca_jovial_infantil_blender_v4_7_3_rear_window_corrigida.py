...
GENERATOR_VERSION = "4.7.3-fusca-jovial-rear-window-rotation-fix"
GROUND_SIZE = 24.0
...
def build_cute_beetle(scene):
    ...
    # Compatibilidade: Euler não suporta multiplicação direta por Vector em
    # todas as versões do Blender. Convertemos explicitamente para Matrix.
    rear_rotation_matrix = rear_rotation_euler.to_matrix()
    rear_outward_normal = (
        rear_rotation_matrix @ Vector((-1.0, 0.0, 0.0))
    ).normalized()
