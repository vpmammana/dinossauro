"""
Carro estilo Fusca jovial — versão 4.5 parametrizada
====================================================

Alterações desta versão:
- remove completamente Rear_Deck e Rear_Deck_Blend;
- parametriza a Body_Shell por meio da lista BODY_SHELL_STATIONS;
- o Windshield agora também gera corte real na Body_Shell;
- o recorte do Windshield usa contorno parametrizado (largura inferior e superior),
  permitindo acompanhar melhor o contorno remanescente da frente da carroceria;
- Side_Window_* e Rear_Window geram cortes reais na Body_Shell por boolean;
- mantém parametrização de Front_Hood, faróis, paralamas dianteiros e traseiros;
- carro vermelho e vidros azul transparentes;
- script idempotente.
"""
...
GENERATOR_VERSION = "4.5-fusca-jovial-bodyshell-parametrizada"
GROUND_SIZE = 24.0
...
# - Para parametrizar a Body_Shell, mexa principalmente em BODY_SHELL_STATIONS.
# - Cada item é:
...
# ---------------------------------------------------------------------------
# FRONT_FENDER_L_BASE — paralama dianteiro esquerdo
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# FRONT_FENDER_R_BASE — paralama dianteiro direito
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# REAR_FENDER_L_BASE — paralama traseiro esquerdo
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# REAR_FENDER_R_BASE — paralama traseiro direito
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# WINDSHIELD
# O windshield agora TAMBÉM corta a Body_Shell via boolean.
#
# O contorno do corte frontal pode ser ajustado por:
# - WINDSHIELD_WIDTH_BOTTOM
# - WINDSHIELD_WIDTH_TOP
# Isso permite acompanhar melhor o remanescente da frente da carroceria.
# ---------------------------------------------------------------------------
WINDSHIELD_X = 0.47
WINDSHIELD_Z = 1.30
WINDSHIELD_THICKNESS = 0.06
WINDSHIELD_HEIGHT = 0.60
WINDSHIELD_WIDTH_BOTTOM = 1.06
WINDSHIELD_WIDTH_TOP = 1.34
...
def create_windshield_panel(name, center, width_bottom, width_top, height,
    ...
    return create_mesh_object(
        name=name, vertices=vertices, faces=faces,
        collection=collection, material=material,
        parent=parent, local_location=center,
        smooth=False, rotation=rotation,
    )
...
print("Body_Shell parametrizada: sim")
print("Windshield faz corte real na Body_Shell: sim")
