...
GENERATOR_VERSION = "1.0-styletruck-teclado"
GROUND_SIZE = 90.0
GROUND_MARGIN = 7.0
...
def build_materials():
    materials = {}
    materials["body_red"] = create_principled_material(
        "MAT_Body_Red",
        color=(0.68, 0.10, 0.08),
        roughness=0.54,
    )
    materials["body_cream"] = create_principled_material(
        "MAT_Body_Cream",
        color=(0.82, 0.74, 0.60),
        roughness=0.60,
    )
...
def build_styletruck_model(scene):
    ...
    create_box(
        "Chassis_FrontCross",
        local_center=(2.78, 0.0, 1.02),
        size_xyz=(0.42, 1.82, 0.22),
        collection=model_collection,
        material=materials["chassis"],
        parent=master,
    )
    ...
    create_box(
        "Axle_Front",
        local_center=(2.12, 0.0, 0.84),
        size_xyz=(0.20, 2.40, 0.20),
        collection=model_collection,
        material=materials["chassis"],
        parent=master,
    )
    create_box(
        "Axle_Rear",
        local_center=(-1.88, 0.0, 0.84),
        size_xyz=(0.22, 2.46, 0.22),
        collection=model_collection,
        material=materials["chassis"],
        parent=master,
    )
    ...
    create_box(
        "Cab_Lower",
        local_center=(1.05, 0.0, 1.95),
        size_xyz=(2.12, 2.18, 1.08),
        collection=model_collection,
    ...
    create_box(
        "Cab_Roof",
        local_center=(0.96, 0.0, 2.78),
        size_xyz=(1.58, 2.02, 0.34),
        collection=model_collection,
        material=materials["body_cream"],
        parent=body_ctrl,
    )
    create_box(
        "Cab_A_Pillar_Bar",
        local_center=(1.82, 0.0, 2.44),
        size_xyz=(0.16, 1.86, 0.74),
        collection=model_collection,
        material=materials["body_cream"],
        parent=body_ctrl,
    )
    create_box(
        "Cab_Rear_Panel",
        local_center=(0.18, 0.0, 2.14),
        size_xyz=(0.18, 1.98, 1.12),
        collection=model_collection,
        material=materials["body_red"],
        parent=body_ctrl,
    )
    create_box(
        "Hood_Main",
        local_center=(2.37, 0.0, 1.86),
        size_xyz=(1.28, 1.90, 0.66),
        collection=model_collection,
        material=materials["body_red"],
        parent=body_ctrl,
    )
    create_box(
        "Hood_Top",
        local_center=(2.48, 0.0, 2.18),
        size_xyz=(1.06, 1.76, 0.14),
        collection=model_collection,
        material=materials["body_cream"],
        parent=body_ctrl,
    )
    ...
    create_box(
        "Windshield",
        local_center=(1.73, 0.0, 2.47),
        size_xyz=(0.10, 1.64, 0.62),
        collection=model_collection,
    ...
    create_box(
        "Rear_Window",
        local_center=(0.20, 0.0, 2.41),
        size_xyz=(0.08, 1.38, 0.46),
        collection=model_collection,
        material=materials["glass"],
        parent=body_ctrl,
    )
    create_box(
        "Side_Window_L",
        local_center=(1.05, 0.88, 2.45),
        size_xyz=(1.12, 0.08, 0.52),
        collection=model_collection,
        material=materials["glass"],
        parent=body_ctrl,
    )
    ...
    for side_name, side_sign in (("L", 1.0), ("R", -1.0)):
        create_ellipsoid(
            ...
            local_center=(2.18, 1.16 * side_sign, 1.35),
            radii=(0.88, 0.34, 0.58),
            collection=model_collection,
            material=materials["body_red"],
            parent=body_ctrl,
        )
        create_ellipsoid(
            ...
            local_center=(-1.88, 1.16 * side_sign, 1.43),
            radii=(1.08, 0.36, 0.70),
            collection=model_collection,
            material=materials["body_red"],
            parent=body_ctrl,
        )
    ...
    create_box(
        "Grille",
        local_center=(3.02, 0.0, 1.73),
        size_xyz=(0.16, 1.58, 0.70),
        collection=model_collection,
        material=materials["chrome"],
        parent=body_ctrl,
    )
    ...
    for side_name, side_sign in (("L", 1.0), ("R", -1.0)):
        create_ellipsoid(
            ...
            local_center=(3.10, 0.68 * side_sign, 1.80),
    ...
    create_box(
        "Flatbed_Main",
        local_center=(-0.76, 0.0, 1.72),
        size_xyz=(4.90, 2.32, 0.18),
        collection=model_collection,
    ...
    create_box(
        "Flatbed_Edge_L",
        local_center=(-0.76, 1.10, 1.84),
        size_xyz=(4.90, 0.08, 0.16),
        collection=model_collection,
        material=materials["body_cream"],
        parent=body_ctrl,
    )
    ...
    create_box(
        ...
        local_center=(-1.90, 0.0, 1.47),
        size_xyz=(0.24, 1.52, 0.42),
        collection=model_collection,
        material=materials["chassis"],
        parent=body_ctrl,
    )
    ...
    create_box(
        "Tow_Post_L",
        local_center=(0.35, 0.74, 2.44),
        size_xyz=(0.16, 0.16, 1.18),
        collection=model_collection,
        material=materials["chrome"],
        parent=body_ctrl,
    )
    ...
    create_box(
        "Tow_Crossbar",
        local_center=(0.35, 0.0, 2.98),
        size_xyz=(0.16, 1.72, 0.14),
        collection=model_collection,
        material=materials["chrome"],
        parent=body_ctrl,
    )
    create_box(
        "Tow_Winch_Box",
        local_center=(-0.08, 0.0, 2.10),
        size_xyz=(0.48, 0.98, 0.28),
        collection=model_collection,
        material=materials["chassis"],
        parent=body_ctrl,
    )
    ...
    create_box(
        "Roof_Light_Bar",
        local_center=(0.94, 0.0, 3.06),
        size_xyz=(0.72, 0.18, 0.12),
        collection=model_collection,
        material=materials["chrome"],
        parent=body_ctrl,
    )
    ...
    create_box(
        "Rear_Bumper",
        local_center=(-3.34, 0.0, 1.08),
        size_xyz=(0.18, 2.16, 0.16),
        collection=model_collection,
        material=materials["chrome"],
        parent=body_ctrl,
    )
    for side_name, side_sign in (("L", 1.0), ("R", -1.0)):
        create_box(
            ...
            local_center=(-3.20, 0.78 * side_sign, 1.60),
    ...
    create_box(
        "Step_L",
        local_center=(1.12, 1.18, 1.22),
        size_xyz=(1.20, 0.18, 0.08),
        collection=model_collection,
        material=materials["chrome"],
        parent=body_ctrl,
    )
    ...
    steer_fl = create_empty(
        ...
        local_location=(2.12, 1.38, WHEEL_RADIUS),
        collection=control_collection,
        parent=master,
        display_type="CIRCLE",
        display_size=0.18,
...
print("=" * 72)
print("Caminhão guincho plataforma estilizado reconstruído com sucesso.")
