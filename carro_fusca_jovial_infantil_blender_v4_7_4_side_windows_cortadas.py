"""
Carro estilo Fusca jovial — versão 4.7.4 parametrizada
======================================================

Correções desta versão:
- remove totalmente o objeto visível Rear_Window; permanece só o recorte;
- inclina para dentro a borda superior das quatro janelas laterais;
- usa cutters laterais profundos e independentes, abrindo vãos reais;
- cria os vidros laterais somente depois dos booleans;
- cada vidro lateral visível é uma única superfície;
- preserva o para-brisa contornado e a limpeza idempotente.
"""
...
GENERATOR_VERSION = "4.7.4-fusca-jovial-side-windows-cut-no-rear-glass"
GROUND_SIZE = 24.0
...
# Cutter separado, profundo o bastante para atravessar a Body_Shell.
SIDE_WINDOW_FRONT_CUTTER_DEPTH = 0.76
SIDE_WINDOW_FRONT_OPENING_SCALE_X = 1.055
SIDE_WINDOW_FRONT_OPENING_SCALE_Z = 1.075
...
SIDE_WINDOW_REAR_CUTTER_DEPTH = 0.76
SIDE_WINDOW_REAR_OPENING_SCALE_X = 1.060
SIDE_WINDOW_REAR_OPENING_SCALE_Z = 1.085
...
def create_side_window_surface(
    ...
    outward = (
        rotation_matrix @ Vector((0.0, float(side_sign), 0.0))
    ).normalized()
...
def create_side_window_cutter(
    ...
    """Prisma trapezoidal profundo que atravessa realmente a lateral."""
